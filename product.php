...
if ($result->num_rows > 0) {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="'.$row['img'].'">
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 class="text-sm title-font text-gray-500 tracking-widest">'.$row['category'].'</h2>
        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">'.$row["proname"].'</h1>
        <div class="flex mb-4">
        ...
        <div class="flex">
          <span class="title-font font-medium text-2xl text-gray-900">Rs. '.$row['price'].'</span>
        ...
        <input type="text" name="proname" value="'.$row['proname'].'" hidden>
        <input type="text" name="img" value="'.$row["img"].'" hidden>
